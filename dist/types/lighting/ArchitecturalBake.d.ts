...
export declare const createArchitecturalBake: (width: number, depth: number, height: number, quality: QualitySettings, ceilingLightIntensity?: number, textureCycleDepth?: number) => Group;
