...
export const TEXTURE_LIBRARY = {
  ...
  tiles: {
    label: "Tiles",
    colorUrl: "/textures/tiles/tiles_color.jpg",
    normalUrl: "/textures/tiles/tiles_normal.jpg",
    tint: "#ffffff",
    accent: "#6d5b43",
    emissive: "#2a2118",
    normalScale: 0.72,
  ...
  woodTiles: {
    label: "Wood Tiles",
    colorUrl: "/textures/wood_tiles/wood_tiles_color.jpg",
    normalUrl: "/textures/wood_tiles/wood_tiles_normal.jpg",
    tint: "#ffffff",
    accent: "#6d5b43",
    emissive: "#2a2118",
    normalScale: 0.72,
  ...
  darkSand: {
    label: "Dark Sand",
    colorUrl: "/textures/dark_sand/dark_sand_color.jpg",
    normalUrl: "/textures/dark_sand/dark_sand_normal.jpg",
    tint: "#ffffff",
    accent: "#6d5b43",
    emissive: "#2a2118",
    normalScale: 0.72,
  ...
  sand: {
    label: "Sand",
    colorUrl: "/textures/sand/sand_color.jpg",
    normalUrl: "/textures/sand/sand_normal.jpg",
    tint: "#ffffff",
    accent: "#6d5b43",
    emissive: "#2a2118",
    normalScale: 0.72,
  ...
  rocks: {
    label: "Rocks",
    colorUrl: "/textures/rocks/rocks_color.jpg",
    normalUrl: "/textures/rocks/rocks_normal.jpg",
    tint: "#ffffff",
    accent: "#6d5b43",
    emissive: "#2a2118",
    normalScale: 0.72,
